...
const ExpiredAssignList = () => {
    ...
    const columns = useMemo(() => [
        ...
        columnHelper.accessor(row => row.inventoryProductDetail?.grInventoryProduct?.product?.name || row.inventoryProductDetail?.grInventoryProduct?.category?.name || 'Unknown Product', {
            id: 'productName',
            header: 'Product Name',
            size: 160,
        }),
        ...
        columnHelper.accessor(row => {
            const gr = row.inventoryProductDetail?.grInventoryProduct;
            return gr?.product?.brand?.name || gr?.brand?.name || 'N/A';
        }, {
            id: 'brand',
            header: 'Brand',
            size: 100,

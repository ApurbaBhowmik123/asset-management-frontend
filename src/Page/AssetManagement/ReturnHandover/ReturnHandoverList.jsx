    ...
    const columns = useMemo(() => [
        ...
        columnHelper.accessor('inventoryProductDetail.grInventoryProduct.product.category.name', {
            ...
            Cell: ({ row }) => {
                ...
                const catObj = specValues.find(sv => sv.specField?.name === 'Category');
                return catObj ? catObj.value : 'N/A'; // We might need a better way if this isn't right, but usually Category is fetched.
            },
        }),
        columnHelper.accessor('status', {
            ...
            Cell: ({ cell }) => {
                ...
                const displayStatus = status === 'Active' ? 'Pending Handover' : status;
                const color = status === 'Active' ? '#ff9800' : '#345481';
                return (
